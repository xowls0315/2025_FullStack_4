export const data = {
    ...
    data: {
        ...
        Ambessa: {
            ...
            name: "암베사",
            title: "전장의 우두머리",
            blurb: "메다르다라는 이름을 들어본 이는 모두 그 가문의 수장 암베사를 경외합니다. 녹서스 장군으로서의 암베사는 압도적인 힘과 단호한 결단력으로 전투에 나서는 치명적인 존재입니다. 가주로서의 암베사 역시 별반 다르지 않습니다. 메다르다 가문의 권력을 뒷받침하는 건 실패나 동정의 여지를 두지 않는 교활한 책략이기 때문입니다. 늑대의 무자비함을 받아들인 암베사는 가문의 유산을 지키기 위해서라면 무엇이든 할 각오가 되어 있습니다. 그게 자식과의 단절을 뜻하더라도...",
            info: {
                attack: 9,
                defense: 2,
                magic: 0,
        ...
        Caitlyn: {
            ...
            name: "케이틀린",
            title: "필트오버의 보안관",
            blurb: "필트오버 제일가는 평화 수호자로 명성이 자자한 케이틀린 키라먼은 이 도시에서 가장 뛰어난 명사수이기도 하다. 그 잡기 어렵다는 필트오버의 범죄 조직들도 그녀의 손에 소탕되었다. 케이틀린은 주로 바이와 짝을 이루어, 바이의 불같은 성미를 자신의 냉철함으로 보완하며 멋진 콤비로 활약한다. 케이틀린의 마법공학 소총이 독보적으로 우수한 성능인 것은 사실이지만, 정작 케이틀린의 가장 강력한 무기는 따로 있다. 필트오버에서 활개 칠 생각을 할 정도로 무모한...",
            info: {
                attack: 8,
                defense: 2,
                magic: 2,
        ...
        Ekko: {
            ...
            name: "에코",
            title: "시간을 달리는 소년",
            blurb: "자운 뒷골목 출신의 천재 소년 에코는 언제든 자신에게 유리하게 시간을 조작할 수 있다. 직접 발명한 Z 드라이브를 이용해 다양한 시공간에서 가능성의 갈래를 탐험하며 완벽한 순간을 포착하는 에코는 한 번의 시행착오도 없이 매번 불가능한 일을 해내는 것처럼 보인다. 누구보다도 자유로운 영혼을 가졌지만 소중한 사람들을 구하기 위해서라면 점화단과 함께 어떤 위험도 무릅쓴다.",
            info: {
                attack: 5,
                defense: 3,
                magic: 7,
        ...
        Gragas: {
            ...
            name: "그라가스",
            title: "술취한 난동꾼",
            blurb: "그라가스는 몸집이 크고 소란스러워서 한 번 보면 잊기 힘든 쾌활한 주조가로, 언제나 모두의 기운을 북돋울 새로운 방법을 찾고 있습니다. 그라가스가 어디서 왔는지는 아무도 모르지만, 프렐요드의 때 묻지 않은 불모지를 뒤지며 희귀한 재료를 찾아 완벽한 최신 혼합물을 만듭니다. 그라가스는 완고하고, 충동적이며, 소동을 일으키는 것으로 유명한데, 그 소동은 밤샘 파티와 엄청난 기물 파손으로 이어지곤 합니다. 그라가스를 보게 된다면 곧 즐거움, 그리고 파괴가...",
            info: {
                attack: 4,
                defense: 7,
                magic: 6,
        ...
        Heimerdinger: {
            ...
            name: "하이머딩거",
            title: "위대한 발명가",
            blurb: "괴짜 성향이 다분한 세실 B. 하이머딩거 교수는 세계에서 가장 혁신적인 인재로 손꼽히며 모든 이의 존경을 받는 발명가다. 필트오버 의회에서 최장기간 재임한 의원인 그는 진보를 향한 도시의 끝없는 욕망이 불러온 최고의 결과와 최악의 결과를 모두 목격했다. 그럼에도 뛰어난 과학자이자 교육자인 하이머딩거 교수는 자신이 만든 특이한 장치로 타인의 삶을 개선하는 일을 게을리하지 않는다.",
            info: {
                attack: 2,
                defense: 6,
                magic: 8,
        ...
        Jayce: {
            ...
            name: "제이스",
            title: "미래의 수호자",
            blurb: "제이스 탈리스는 친구 빅토르와 함께 마법공학 분야 최초의 위대한 발견을 이뤄 낸 뛰어난 발명가다. 필트오버 전역에서 찬사를 받는 그는 '진보의 주인공'이라는 명성에 걸맞게 살고자 하지만 자신을 향한 기대감에 종종 버거워하곤 한다. 이로 인해 제이스는 자신의 발명품이 필트오버와 자운 사이의 분열을 키웠다는 사실을 깨닫기 시작했다. 마법공학 해머로 무장한 그는 내일을 지킬 만반의 준비를 끝냈다.",
            info: {
                attack: 8,
                defense: 4,
                magic: 3,
        ...
        Jinx: {
            ...
            name: "징크스",
            title: "난폭한 말괄량이",
            blurb: "지하도시 출신의 충동적이고 불안정한 범죄자 징크스는 자신의 과거가 빚어낸 결과에 시달리면서도 필트오버와 자운에 특유의 대혼란을 일으키는 것을 멈추지 않는다. 손수 만든 무기를 파괴적으로 사용해 화려한 폭발과 총격을 쏟아내며 가는 곳마다 쑥대밭을 만들어 소외된 자들을 반란과 저항으로 이끈다.",
            info: {
                attack: 9,
                defense: 2,
                magic: 4,
        ...
        Lucian: {
            ...
            name: "루시안",
            title: "정화의 사도",
            blurb: "빛의 감시자 루시안은 악령과 망령을 사냥하는 음울한 사냥꾼으로, 언데드들을 끈질기게 추적하여 유물 쌍권총으로 말살시켜 버린다. 악령 쓰레쉬의 손에 아내를 잃고 복수만을 노렸지만, 아내가 살아 돌아온 후에도 루시안의 분노는 수그러들지 않았다. 외골수에다 자비를 모르는 루시안은 검은 안개가 끝없이 내뿜는 공포의 악령들에게서 살아 있는 존재들을 지키기 위해서라면 어떤 일도 서슴지 않을 것이다.",
            info: {
                attack: 8,
                defense: 5,
                magic: 3,
        ...
        Mel: {
            ...
            name: "멜",
            title: "영혼의 반향",
            blurb: "멜 메다르다는 한때 녹서스에서 손꼽히는 세도가 중 하나였던 메다르다 가문의 후계자로 추정된다. 겉보기에는 우아한 귀족이지만 그 이면에는 자신이 만나는 모든 사람의 모든 것을 파악하는 노련한 정치가가 있다. 수수께끼에 싸인 검은 장미단과 조우한 후, 멜은 어머니의 기만이 얼마나 깊은지 알아냈고 처음으로 자신의 통제력을 벗어난 상황에 직면했다. 각성하여 마법의 힘을 손에 넣은 멜은 답을 찾아 고향으로 향했다. 멜 내면의 빛을 길들이고자 하는 이는 여전히...",
            info: {
                attack: 2,
                defense: 4,
                magic: 9,
        ...
        Senna: {
            ...
            name: "세나",
            title: "구원자",
            blurb: "어린 시절부터 초자연적인 검은 안개에 쫓기는 저주를 받은 세나는 빛의 감시자들이라는 신성한 조직에 합류하여 검은 안개에 맹렬히 저항하지만, 잔혹한 악령 쓰레쉬의 손에 쓰러지고 랜턴에 영혼을 사로잡히게 된다. 그러나 희망을 잃지 않은 그녀는 랜턴 안에서 안개의 힘을 활용하는 법을 배워 완전히 새로운 모습으로 다시 태어난다. 제 빛과 어둠을 모두 다스릴 수 있게 된 세나는 검은 안개를 자멸케 하고자 한다. 세나의 유물 무기가 불을 뿜을 때마다, 검은...",
            info: {
                attack: 7,
                defense: 2,
                magic: 6,
        ...
        Singed: {
            ...
            name: "신지드",
            title: "미친 화학자",
            blurb: "뛰어나지만 도의를 모르는 화학자 신지드의 실험은 가장 극악무도한 범죄자조차 역겨워할 정도다. 최고 입찰자에게 자신의 기술을 팔아넘기는 그는 자신이 만든 유독한 혼합물이 어떻게 쓰이든 거의 신경 쓰지 않으며 그로 인한 혼돈마저 하나의 실험으로 여긴다. 신지드의 가장 악명 높은 작품 '시머' 덕분에 화공 남작들이 자운을 제멋대로 주무를 수 있게 됐지만, 광기에 사로잡힌 신지드는 늘 새로운 것을 연구하며 그때마다 이전보다 더 끔찍한 실험을 진행한다...",
            info: {
                attack: 4,
                defense: 8,
                magic: 7,
        ...
        Vi: {
            ...
            name: "바이",
            title: "필트오버의 집행자",
            blurb: "자운의 암흑가에서 자란 다혈질 성격의 바이는 충동적이고 성급한 데다가 권위에 대한 존중이라고는 눈곱만큼도 없다. 윗동네에서 사고를 치고 다니던 어린 시절에도 스틸워터 교도소에서 부당하게 긴 징역살이를 했을 때도 언제나 상황을 빠르게 판단하며 살아남았다. 이제 평화를 깨는 대신 유지하기 위해 필트오버의 집행자가 된 바이는 육중한 벽을 단숨에 부술 만큼 무시무시한 마법공학 건틀릿을 휘두르며 범죄자를 색출하고 있다.",
            info: {
                attack: 8,
                defense: 5,
                magic: 3,
        ...
        Viego: {
            ...
            name: "비에고",
            title: "몰락한 왕",
            blurb: "비에고는 오래전 잊힌 왕국의 지배자였다. 천년도 전에, 그는 아내 이졸데를 죽음에서 되찾고자 시도한 끝에 현재 대몰락으로 불리는 마법 재해를 일으켰다. 그 안에서 죽음을 맞은 비에고는 강력한 언데드 망령이 되었으나, 죽은 지 수백 년은 지난 왕비를 향한 집착에 여전히 고통받았다. 이제 비에고는 몰락한 왕으로 군림하여 죽음의 해로윙을 지배한다. 이졸데를 치유할 가망이 있는 것이라면 무엇이든 찾아 룬테라를 뒤지며, 잔혹한 심장의 상처에서 끝없이 쏟아지는...",
            info: {
                attack: 6,
                defense: 4,
                magic: 2,
        ...
        Viktor: {
            ...
            name: "빅토르",
            title: "아케인의 전령관",
            blurb: "과거의 모습을 벗어던지고 완전한 생체기계로 변모한 빅토르는 영광스러운 진화를 받아들이고 추종자들의 구세주와 같은 존재가 되었다. 감정을 제거하면 고통도 제거될 것이라는 논리로 자신의 인간성을 희생한 빅토르는 이제 온 세상에 마공학 핵의 진리를 전파하고자 한다. 설령 세상이 그 혜택을 이해하지 못하더라도 상관없다. 결국 이 비전의 대가에게 폭력이란 궁극적인 상황에서 균형을 잡는 데 필요한 변수일 뿐이니까.",
            info: {
                attack: 2,
                defense: 4,
                magic: 10,
        ...
        Warwick: {
            ...
            name: "워윅",
            title: "자운의 고삐 풀린 분노",
            blurb: "자운의 잿빛 골목을 무대로 사냥감을 찾는 괴수 워윅. 극한의 고통을 동반하는 각종 실험으로 완전히 변형된 그의 육체는 약품통, 펌프, 여러 기계가 결합된 복잡한 시스템과 연결되어 있으며, 정맥에는 연금술을 통해 조합한 분노가 주입된다. 어두운 그림자 속에서 느닷없이 튀어나오곤 하는 그는 사람들을 위협하는 도시의 범죄자들을 단숨에 사냥한다. 피 냄새를 맡고 나면 이성을 잃고 마는 워윅... 조금이라도 피를 흘린 자는 그 누구도 워윅의 손아귀에서 벗어날...",
            info: {
                attack: 9,
                defense: 5,
                magic: 3,
        ...
        Yorick: {
            ...
            name: "요릭",
            title: "영혼의 길잡이",
            blurb: "오래전 잊힌 종교 교단의 마지막 생존자 요릭은 망자를 거느리는, 축복이자 저주인 능력을 소유하고 있다. 그에게로 몰려드는 썩은 시체와 울부짖는 망령은 그림자 군도에 발이 묶인 그의 유일한 동반자다. 대몰락의 저주로부터 조국을 구원하겠다는 신성한 뜻을 품고 있지만 그의 행동은 괴이하기만 하다.",
            info: {
                attack: 6,
                defense: 6,
                magic: 4,
        ...
        Yunara: {
            ...
            name: "유나라",
            title: "꺾이지 않는 신념",
            blurb: "유나라는 아이오니아에 대한 변함없는 헌신으로, 수 세기 동안 영혼 세계에 칩거하며 전설적인 킨코우 유물인 에이온 에르나를 다루는 법을 연마했습니다. 많은 것을 희생했음에도, 이 땅에서 불화와 갈등을 몰아내겠다는 유나라의 맹세는 그 신념만큼이나 굳건했습니다. 그러나 그녀를 기다리는 세상과, 다시금 그림자를 드리운 고대의 위협은 그 결의를 극한까지 시험할 것입니다.",
            info: {
                attack: 9,
                defense: 2,
                magic: 0,
